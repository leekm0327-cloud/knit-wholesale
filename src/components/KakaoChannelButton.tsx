...
export function KakaoChannelButton() {
  return (
    <a
      ...
      className="group fixed bottom-16 right-5 z-50 flex items-center gap-2 rounded-none bg-foreground px-4 py-3.5 text-background shadow-lg ring-1 ring-foreground/10 transition-all duration-200 hover:-translate-y-0.5 hover:shadow-xl sm:bottom-7 sm:right-7"
    >
