...
db.exec("INSERT INTO bank_review(id,account,ref,at,deposit,withdraw,remark,currency) VALUES(1,'123','a','20260908100000',0,1000,'식자재','KRW'),(2,'123','b','20260908100000',2000,0,'카페','KRW'),(3,'123','c','20260908100000',0,3000,'카드','KRW');UPDATE bank_review SET state='card' WHERE id=3;");
