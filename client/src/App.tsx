...
import AdminAlimtalk from "@/pages/admin/AdminAlimtalk";
...
import AdminExpenseDuplicates from "@/pages/admin/AdminExpenseDuplicates";
...
import StaffSupply from "@/pages/staff/StaffSupply";
...
function AppRouter() {
  ...
  return (
    <Switch>
      ...
      <Route path="/admin/alimtalk" component={AdminAlimtalk} />
      ...
      <Route path="/admin/expense-duplicates" component={AdminExpenseDuplicates} />
      ...
      <Route path="/staff/supply" component={StaffSupply} />
