        ...
        <div className="mt-10 grid gap-10 lg:grid-cols-[220px_1fr]">
          ...
          <article className="space-y-14">
            ...
            <section>
              ...
              <Tip>
                이메일은 세금계산서 발행·주문 알림·비밀번호 재설정 안내에 모두 사용돼요. 담당자가 바뀌면 직접 수정해주세요.
              </Tip>
            </section>
            ...
            <section>
              ...
              <div className="mt-5 space-y-5">
                {[
                  {
                    q: "최소 주문 수량이 있나요?",
                    a: "원두는 1kg 단위로 담되, 한 번에 총 5kg 이상부터 주문할 수 있어요. (샘플 제외)",
                  },
                  {
                    q: "분쇄해서 보내주실 수 있나요?",
                  ...
                  {
                    q: "세금계산서는 자동 발행되나요?",
                    a: "네, 매월 정해진 날짜에 일괄 발행돼요. 내 정보에 등록된 이메일로 받아보실 수 있어요.",
                  },
                  {
                    q: "주문을 잘못했어요, 어떻게 하죠?",
